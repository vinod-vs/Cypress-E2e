...
TestFilter(['B2C', 'API', 'P0'], () => {
  describe('Rocket orderID is created,saved and published successfully', () => {
    ...
    const mongoURI = Cypress.env('rocketMongoURI')
    const mongoDB = Cypress.env('rocketMongoDB')
    const mongoDBCollection = Cypress.env('rocketMongoDBCollection')
    const filterKey = 'traderOrderId'
