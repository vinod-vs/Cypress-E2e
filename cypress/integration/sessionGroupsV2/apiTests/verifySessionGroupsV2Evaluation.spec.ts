...
TestFilter(['B2C', 'SessionGroupsV2', 'API', 'P0', 'CONWAY'], () => {
  describe('[API] Verify Session Group v2 Evaluation', () => {
    before(() => {
      cy.clearCookies({ domain: null })
      cy.clearLocalStorage({ domain: null })
    })
    it('Verify required attributes can trigger Session Groups v2 using isingroupbyid end point', () => {
    ...
    it('Verify promotion combination attributes can trigger Session Groups v2 using isingroupbyid end point', () => {
