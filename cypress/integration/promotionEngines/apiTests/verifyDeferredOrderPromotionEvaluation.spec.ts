...
TestFilter(['B2C','PES','API'], () => {
  ...
  describe('[API] Verify Order Promotions', () => {
    ...
    it('Verify the Deferred order promotion is applied and added the reward points- $OFF', () => {
      ...
      cy.addAvailableNonRestrictedPriceLimitedWowItemsToTrolley(promotions.DeferredOrderPromotions[0].searchTerm,(promotions.DeferredOrderPromotions[0].Subtotal)).then((response:any)=> {
