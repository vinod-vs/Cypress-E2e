...
TestFilter(['EDM', 'API', 'EDM-E2E-API'], () => {
  describe('[API] RP-5039 - Full dispatch Everyday Market order via Marketplacer', () => {
    ...
    it('RP-5039 - Full dispatch Everyday Market order via Marketplacer', () => {
      ...
      const rewardsCardNumber = shoppers.emAccountWithRewards19.rewardsCardNumber

      // Login and place the order from testdata
      cy.loginAndPlaceRequiredOrderFromTestdata(shoppers.emAccountWithRewards19, testData).then((response) => {
