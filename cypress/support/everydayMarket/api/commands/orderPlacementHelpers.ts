...
Cypress.Commands.add('prepareLineItemForWowAndEdmOrderForDU', (searchTerm, marketSubTotalUpperLimit) => {
  // Set fulfilment using the new /windows endpoint
  ...
  // Add both WOW and EDM items to trolley
  cy.addAvailableNonRestrictedWowItemsToTrolley(search.searchTerm)
  cy.addAvailableEDMItemsToTrolleyForDU(searchTerm, marketSubTotalUpperLimit)
})
