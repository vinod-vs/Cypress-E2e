...
export class TextBox {
  private readonly textBoxBase = 'textBoxBase'
  private readonly sharedTextBoxTag = 'shared-textbox'
  private readonly inputTag = 'input'
  private readonly labelTag = 'label'
  private readonly clearText = '.clear-text'
