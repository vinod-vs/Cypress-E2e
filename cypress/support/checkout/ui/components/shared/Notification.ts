export class Notification {
  private sharedNotificationTag = 'shared-notification'
  private notificationContainer = ".notification-container";
  private textContainer = ".text-container";
  private primaryHeaderText = "p"; // find within context of the text container
  private secondaryHeaderText = ".small-heading"; // find within context of the text container
