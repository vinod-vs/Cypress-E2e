...
export abstract class CheckoutAccordionPanel {
  ...
  private cancelBtn(): Button {
    return new Button(
      cy
        .get(this.panelBaseLocatorString)
        .find('.auto_checkout-accordion-panel-button__cancel')
    )
  }
  ...
  private continueBtn(): Button {
    return new Button(
      cy
        .get(this.panelBaseLocatorString)
        .find('.auto_checkout-accordion-panel-button__submit')
    )
  }

  private editBtn(): Cypress.Chainable<JQuery<HTMLElement>> {
    return cy
      .get(this.panelBaseLocatorString)
      .find('.auto_checkout-accordion-panel-button__change')
  }
  ...
  public getPanelHeadingText(): Cypress.Chainable<string> {
    return cy
      .get('panelBaseLocatorString')
      .find('.panel-heading-text')
      .invoke('text')
  }
}
